...
namespace Etalem.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ICategoryService categoryService, CourseService courseService, ApplicationDbContext context, ILogger<HomeController> logger, ApplicationDbContext applicationDbContext)
        {
